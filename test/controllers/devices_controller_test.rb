...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference('Device.count') do
      post devices_url, params: { device: { device_id: @device.device_id, device_name: @device.device_name } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { device_id: @device.device_id, device_name: @device.device_name } }
